...
const SubComment = ({ subcomments }) => {
  return (
    <div className="publication-subcomments flex flex-col mt-3">
      {subcomments.map((com) => (
            ...
            <div className="publication-subcomment-content w-full px-3 py-2 flex flex-col">
              <div className="publication-subcomment-content-top flex justify-between">
                <div className="publication-subcomment-author">
                  <div className="publication-subcomment-author-name">{com.author} <span>• {com.author_connection_level}</span></div>
